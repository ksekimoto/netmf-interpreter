...
HRESULT Library_CQ_NETMF_SD_CQ_NETMF_SD_StorageDevice::SDSPI_Mount___STATIC__VOID__STRING__U4__U4__U4( CLR_RT_StackFrame& stack )
{
...
HRESULT Library_CQ_NETMF_SD_CQ_NETMF_SD_StorageDevice::SDSPI_Unmount___STATIC__VOID( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
