...
#include <tinyhal.h>
#include "..\RX65N.h"
#include "RX65N_ANALOG.h"

const UINT32 RX65N_AD_Driver::c10bits_Pins[RX65N_AD_Driver::c_Channels] =
{
    RX65N_GPIO::PE2, RX65N_GPIO::PE3, RX65N_GPIO::PE4, RX65N_GPIO::PE5,
    RX65N_GPIO::PE6, RX65N_GPIO::PE7, RX65N_GPIO::PD6, RX65N_GPIO::PD7
};

const UINT32 RX65N_AD_Driver::c12bits_Pins[RX65N_AD_Driver::c_Channels] =
{
    RX65N_GPIO::P40, RX65N_GPIO::P41, RX65N_GPIO::P42, RX65N_GPIO::P43,
    RX65N_GPIO::P44, RX65N_GPIO::P45, RX65N_GPIO::P46, RX65N_GPIO::P47
};
...
RX65N_AD_Driver g_RX65N_AD_Driver;
...
BOOL AD_Initialize(ANALOG_CHANNEL channel, INT32 precisionInBits)
{
    ...
    if ((UINT32)channel >= g_RX65N_AD_Driver.c_Channels)
        return FALSE;
...
{
    return RX65N_AD_Driver::c_Channels;
}
...
GPIO_PIN AD_GetPinForChannel(ANALOG_CHANNEL channel)
{
    ...
    if (m_Precision == 10)
        return g_RX65N_AD_Driver.c10bits_Pins[channel];
    else
        return g_RX65N_AD_Driver.c12bits_Pins[channel];
}

BOOL AD_GetAvailablePrecisionsForChannel(ANALOG_CHANNEL channel, INT32* precisions, UINT32& size)
{
    size = 0;
    if (precisions == NULL || (UINT32)channel >= g_RX65N_AD_Driver.c_Channels)
        return FALSE;
