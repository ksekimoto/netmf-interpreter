...
RX65N_I2CSW_Driver g_RX65N_I2CSW_Driver;

BOOL RX65N_I2CSW_Driver::Initialize()
{
    NATIVE_PROFILE_HAL_PROCESSOR_I2C();
    g_RX65N_I2CSW_Driver.m_currentXAction = NULL;
    g_RX65N_I2CSW_Driver.m_currentXActionUnit = NULL;
    i2c_init();
...
BOOL RX65N_I2CSW_Driver::Uninitialize()
{
    NATIVE_PROFILE_HAL_PROCESSOR_I2C();
    g_RX65N_I2CSW_Driver.m_currentXAction = NULL;
    g_RX65N_I2CSW_Driver.m_currentXActionUnit = NULL;
...
void RX65N_I2CSW_Driver::Abort(void)
{
    I2C_HAL_XACTION *xAction = g_RX65N_I2CSW_Driver.m_currentXAction;
    i2c_stopbit();
    xAction->Signal(I2C_HAL_XACTION::c_Status_Aborted);
}

void RX65N_I2CSW_Driver::WriteToSubordinate(I2C_HAL_XACTION_UNIT *unit)
{
    UINT8 *queueData;
...
void RX65N_I2CSW_Driver::ReadFromSubordinate(I2C_HAL_XACTION_UNIT *unit)
{
    UINT8* queueData;
...
void RX65N_I2CSW_Driver::MasterXAction_Start(I2C_HAL_XACTION* xAction, bool repeatedStart)
{
    UINT8 address;
    NATIVE_PROFILE_HAL_PROCESSOR_I2C();
    g_RX65N_I2CSW_Driver.m_currentXAction = xAction;
    g_RX65N_I2CSW_Driver.m_currentXActionUnit = xAction->m_xActionUnits[xAction->m_current++];
    I2C_HAL_XACTION_UNIT *unit = g_RX65N_I2CSW_Driver.m_currentXActionUnit;
#ifdef DEBUG_I2CSW
    ...
    address |= unit->IsReadXActionUnit() ? RX65N_I2CSW_Driver::c_DirectionRead : RX65N_I2CSW_Driver::c_DirectionWrite;
...
void RX65N_I2CSW_Driver::MasterXAction_Stop()
{
    NATIVE_PROFILE_HAL_PROCESSOR_I2C();
#ifdef DEBUG_I2CSW
...
void RX65N_I2CSW_Driver::GetClockRate(UINT32 rateKhz, UINT8& clockRate, UINT8& clockRate2)
{
    // ToDo
}

void RX65N_I2CSW_Driver::GetPins(GPIO_PIN& scl, GPIO_PIN& sda)
{
    NATIVE_PROFILE_HAL_PROCESSOR_I2C();
    scl = SCLPIN;
    sda = SDAPIN;
