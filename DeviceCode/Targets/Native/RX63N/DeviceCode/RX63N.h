...
#define RX63N_MAX_GPIO_PINS    152
#define RX63N_MAX_GPIO_PORTS    (RX63N_MAX_GPIO_PINS/8)

#define GPIO_PORT(pin)  (pin >> 3)
#define GPIO_MASK(pin)  (1 << (pin & 7))

#define _PXXPFS(port, bit)  ((volatile UINT8 *)(0x0008c140 + port*8 + bit))
...
#define _ODR0(port) (*(volatile UINT8 *)(0x0008c080 + port*2))
#define _ODR1(port) (*(volatile UINT8 *)(0x0008c081 + port*2))
...
//extern RX63N_Driver g_RX63N_Driver;
...
extern RX63N_USART_Driver g_RX63N_USART_Driver;
...
#define RX63N_GPIO_POLLING_INTERVAL 5000

struct RX63N_GPIO_Driver
{
    ...
    static const UINT32 c_MaxPins = RX63N_MAX_GPIO_PINS;
    static const UINT32 c_MaxPorts = RX63N_MAX_GPIO_PORTS;
...
//extern RX63N_GPIO_Driver g_RX63N_GPIO_Driver;
...
struct RX63N_I2C_Driver
{
    ...
    static void RX63N_I2C_ICEEI_ISR(UINT32 ch);
    static void RX63N_I2C_ICRXI_ISR(UINT32 ch);
    static void RX63N_I2C_ICTXI_ISR(UINT32 ch);
    static void RX63N_I2C_ICTEI_ISR(UINT32 ch);
private:
};

//extern RX63N_I2C_Driver g_RX63N_I2C_Driver;

//
// I2C driver
//////////////////////////////////////////////////////////////////////////////

struct RX63N_I2CSW_Driver
{
    static const UINT8 c_DirectionRead = 1;
    static const UINT8 c_DirectionWrite = 0;
    I2C_HAL_XACTION *m_currentXAction;
...
struct RX63N_WATCHDOG_Driver

{
};

//extern RX63N_WATCHDOG_Driver g_RX63N_WATCHDOG_Driver;
