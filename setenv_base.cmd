...
@rem GOTO :SET_TOOLCHAIN

@rem :VS_ERR
@rem ECHO WARNING: Could not find VsDevCmd.bat.
@rem ECHO WARNING: VISUAL STUDIO 2019 DOES NOT APPEAR TO BE INSTALLED ON THIS MACHINE
...
IF "%COMPILER_TOOL_VERSION_NUM%"=="14" (
  ...
  ECHO "Visual Studio 2015 VsDevCmd.bat starts"
  CALL "%VS140COMNTOOLS%vsvars32.bat"
  GOTO :EOF
)
...
IF "%COMPILER_TOOL_VERSION_NUM%"=="16" (
  IF "" == "%VS160COMNTOOLS%" GOTO BAD_VS_ARG
  ECHO "Visual Studio 2019 VsDevCmd.bat starts"
