...
#define REGION2_BYTES_PER_BLK                  0x8000
#define REGION2_NUM_OF_BLOCKS                  16

#define REGION3_XIP_ADDRESS                    (INTERNALFLASH__BASE_ADDRESS + \
                                                (REGION1_BYTES_PER_BLK * REGION1_NUM_OF_BLOCKS) + \
                                                (REGION2_BYTES_PER_BLK * REGION2_NUM_OF_BLOCKS))
#define REGION3_BYTES_PER_BLK                  0x4000
#define REGION3_NUM_OF_BLOCKS                  28
...
#ifdef R5F563NB
const BlockRange g_INTERNALFLASH_BlockRange1[] =        // 1MB:64Kx16
{
    { BlockRange::BLOCKTYPE_BOOTSTRAP       ,  0,  0 }, // FFE00000 - FFE0FFFF
    { BlockRange::BLOCKTYPE_CODE            ,  1,  7 }, // FFE10000 - FFE7FFFF
    { BlockRange::BLOCKTYPE_CONFIG          ,  8,  8 }, // FFE80000 - FFE8FFFF
    { BlockRange::BLOCKTYPE_DEPLOYMENT      ,  9, 15 }  // FFE90000 - FFEFFFFF
};
const BlockRange g_INTERNALFLASH_BlockRange2[] =        // 512K:32Kx16
{
    { BlockRange::BLOCKTYPE_DEPLOYMENT      ,  0, 15 }  // FFF08000 - FFF7FFFF
};

const BlockRange g_INTERNALFLASH_BlockRange3[] =        // 480K:16Kx30
{
    { BlockRange::BLOCKTYPE_DEPLOYMENT      ,  0, 27 }, // FFF80000 - FFFF3FFF
};
#else
