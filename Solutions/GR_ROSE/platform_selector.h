...
#ifndef _PLATFORM_GR_ROSE_SELECTOR_H_
#define _PLATFORM_GR_ROSE_SELECTOR_H_ 1
...
#define R5F565NE
#define HAL_SYSTEM_NAME                     "GR_ROSE"
...
// CLKDEV(CKS) = 8, 32, 128, 512 -> Needs to change RX65N_TIMER.CPP
...
#define SYSTEM_CYCLE_CLOCK_HZ           120000000       // ICLK
#define SYSTEM_CLOCK_HZ                 120000000       // ICLK
...
//    { 8*6+7, BUTTON_B0 }, /* RX65N_GPIO::P67 */ \
//    { 8*6+6, BUTTON_B1 }, /* RX65N_GPIO::P66 */ \
//    { 8*4+5, BUTTON_B2 }, /* RX65N_GPIO::P45 */ \
//    { 8*4+4, BUTTON_B3 }, /* RX65N_GPIO::P44 */ \
//    { 8*4+7, BUTTON_B4 }, /* RX65N_GPIO::P47 */ \
//    { 8*4+6, BUTTON_B5 }, /* RX65N_GPIO::P46 */
...
#endif // PLATFORM_RX65N_GR_ROSE

#endif // _PLATFORM_GR_ROSE_SELECTOR_H_
