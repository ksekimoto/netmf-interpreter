...
//string descriptor
#define    MANUFACTURER_NAME_SIZE   16  /* "Kentaro Sekimoto*/
#define    PRODUCT_NAME_SIZE        7   /* "GR_ROSE" */
#define    DISPLAY_NAME_SIZE        7   /* "GR_ROSE" */
#define    FRIENDLY_NAME_SIZE       7   /* "GR_ROSE" */
// index for the strings
#define    MANUFACTURER_NAME_INDEX  1
#define    PRODUCT_NAME_INDEX       2
#define    SERIAL_NUMBER_INDEX      0
// device descriptor
#define    PRODUCT_ID               0x045B
#define    VENDOR_ID                0x025A
#define    MAX_EP0_SIZE             64
#define    USB_MAX_CURRENT          250
...
const struct USB_DYNAMIC_CONFIGURATION UsbDefaultConfiguration =
{
    // Device descriptor
    {
        ...
        DEVICE_RELEASE_VERSION,             // Product version 2.00 (BCD)
