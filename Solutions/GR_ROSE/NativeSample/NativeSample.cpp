...
#include <tinyhal.h>
#include "../../GR_CITRUS/NativeSample/nativesample.h"

#ifdef TEST_AD
#include "../../GR_CITRUS/NativeSample/TestAD.cpp"
void TestAD(void);
#endif

#ifdef TEST_BUTTON
#include "../../GR_CITRUS/NativeSample/TestButton.cpp"
void TestButton(void);
#endif

#ifdef TEST_EVENTS
#include "../../GR_CITRUS/NativeSample/TestEvents.cpp"
void TestEvent(void);
#endif

#ifdef TEST_FLASH
#include "../../GR_CITRUS/NativeSample/TestFlash.cpp"
void TestFlash(void);
#endif

#ifdef TEST_I2C
#include "../../GR_CITRUS/NativeSample/TestI2C.cpp"
void TestI2C(void);
#endif

#ifdef TEST_LCD
#include "../../GR_CITRUS/NativeSample/TestLCD.cpp"
void TestLCD(void);
#endif

#ifdef TEST_LWIP
#include "../../GR_CITRUS/NativeSample/TestLwIP.cpp"
void TestlwIP(void);
#endif

#ifdef TEST_MEMORY
#include "../../GR_CITRUS/NativeSample/TestMemory.cpp"
...
#ifdef TEST_SD
#include "../../GR_CITRUS/NativeSample/TestSD.cpp"
void TestSD(void);
#endif

#ifdef TEST_TOUCHPANEL
#include "../../GR_CITRUS/NativeSample/TestTouchPanel.cpp"
void TestTouchPanel(void);
#endif

#ifdef TEST_USB
#include "../../GR_CITRUS/NativeSample/TestUSB.cpp"
void TestUSB(void);
#endif
