...
/*       NB: For GNU users this usage will be different - see user manual       */
/*                                                                              */
...
#define	PORTH	(*(volatile struct st_porth   *)0x8C0D1)
...
#define	RIIC1	(*(volatile struct st_riic1   *)0x88320)
#define	RIIC2	(*(volatile struct st_riic1   *)0x88340)
#define	RIIC3	(*(volatile struct st_riic1   *)0x88360)
...
#define	SCI7	(*(volatile struct st_sci7    *)0x8A0E0)
...
#define	SMCI7	(*(volatile struct st_smci7   *)0x8A0E0)
